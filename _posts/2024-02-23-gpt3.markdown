...
![](https://files.mdnice.com/user/44560/d2d9a247-c59a-489b-b03e-ab9f1aa11a45.png)
...
export LD_LIBRARY_PATH=~/miniconda3/envs/ldm/lib:$LD_LIBRARY_PATH
cd LLM/stable-diffusion/
python3 scripts/txt2img.py --prompt "I was eating fried chicken in People's Square
" --plms --outdir=outputs/txt2img-samples-20240223
```

点击“提交作业”，便可以托管了。吃个瓜，等个几分钟，待任务变成完成时，就可以去验收结果了。

![](https://files.mdnice.com/user/44560/c1580763-c20e-4c39-a4dc-bd6033bc6c79.png)

去目标目录查看图片，我们的指令是生成“**我在人民广场吃着炸鸡**”的图片，6 张图片中，只有第 1 张比较合适，图 2 和图 4 比例不协调，而剩下的图内容上并不符合需求。

![](https://files.mdnice.com/user/44560/7ddf38e9-7dc0-463e-8c51-51b982115762.jpg)
